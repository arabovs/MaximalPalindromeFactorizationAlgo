...
public class Algo {
	...
	public static void main(String[] args) {
		...
		String z = "abbbabababbababbbbababababbabbabababababbababaabababbababab";
		String zz = z + z + z + z + z + z + z + z + z + z;
		String zzz = zz + zz + zz + zz +zz + zz + zz +zz +zz +zz;
		String zzzz = zzz + zzz + zzz +zzz + zzz+ zzz + zzz +zzz + zzz+zzz + zzz;
	//	do{
			System.out.println("Enter a string: ");
	   // 	s = reader.nextLine();
	    //	if(s.isEmpty()||!pattern.matcher( s ).matches())promptUser=true;
	    //	else {algo = new Algo(zzzz);
	    //	printConsole();
	    //	promptUser = false;
	    //	}
		//}
		//while(promptUser);
	    	algo = new Algo(zzz+zzz+zzz+zzz);
